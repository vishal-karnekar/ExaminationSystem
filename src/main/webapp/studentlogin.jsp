			...
			<div class="row gx-lg-5 align-items-center mb-5">
				<div class="col-lg-6 mb-5 mb-lg-0" style="z-index: 10">
					<h1 class="my-5 display-5 fw-bold ls-tight"
						...
						Wel-Come to E-EXAM <br /> <span style="color: hsl(218, 81%, 75%)">Login
							to Upgrade Skill </span>
					</h1>
						...
						<div class="card-body px-4 py-5 px-md-5">
							<form action=validateuser method="post">
								...
								<div class="form-outline mb-4">
									...
									<input type="text" name="txtusername" id="form3Example3"
										class="form-control" />
								</div>
								...
								<div class="form-outline mb-4">
									...
									<input type="password" name="txtpassword" id="form3Example4"
										class="form-control" />
								</div>
								...
								<div class="form-check d-flex justify-content-center mb-4">
									<input class="form-check-input me-2" type="checkbox" value=""
										...
										class="form-check-label" for="form2Example33"> &nbsp
