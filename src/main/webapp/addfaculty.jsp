		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item"><a class="nav-link"
					href="javascript:void(0);"><i class="far fa-calendar-alt"></i>Add
						Faculty</a></li>
				<li class="nav-item"><a class="nav-link"
					href="facultylist.jsp"><i class="far fa-chart-bar"></i>Faculty
						List</a></li>
				<li class="nav-item"><a class="nav-link"
	...
	<diV class=" d-flex align-items-center justify-content-center">
		...
		<div class="testbox">
			<form action="addfaculty" method="post">
				...
				<div class="colums">
					...
					<div class="item">
						<label for="lname"> Last Name<span>*</span></label> <input
							id="lname" type="text" name="lname" required />
					</div>
					<div class="item">
					...
					<div class="question">
						...
						<div class="question-answer">
							<div>
								<input type="radio" value="male" id="radio_1" name="gender" /> <label
									for="radio_1" class="radio"><span>Male</span></label>
							</div>
							<div>
								<input type="radio" value="female" id="radio_2" name="gender" /> <label
									for="radio_2" class="radio"><span>Female</span></label>
							</div>
							<div>
								<input type="radio" value="other" id="radio_2" name="gender"/> <label
									for="radio_2" class="radio"><span>Other</span></label>
							</div>
						</div>
					</div>
				...
				<div class="item">
					<label for="visit">Note</label>
					<textarea id="visit" name="info" rows="3"></textarea>
				</div>
				<div class="btn-block">
