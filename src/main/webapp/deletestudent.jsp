...
<a class="navbar-brand m-0" href="index.jsp"> <img
			...
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item"><a class="nav-link"
					href="javascript:void(0);"><i class="far fa-calendar-alt"></i>Add
						Faculty</a></li>
				<li class="nav-item"><a class="nav-link"
					href="javascript:void(0);"><i class="far fa-chart-bar"></i>Faculty
						List</a></li>
				<li class="nav-item"><a class="nav-link"
	...
	<div class="card text-center">
		<div class="card-header">Remove Student From List</div>
		<div class="card-body">
			<h5 class="card-title">Enter Name To Remove Student</h5>
			<form action="deletestudent" method="post">
				<input type="text" class="form-control" name=txtname
					placeholder="Name"><br> <input type="submit" 
					value="Delete">
			</form>
		</div>
	</div>
