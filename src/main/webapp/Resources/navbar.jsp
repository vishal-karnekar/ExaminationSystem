		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item active"><a class="nav-link"
					href="javascript:void(0);"><i class="fas fa-tachometer-alt"></i>Components</a>
				</li>
				...
				<li class="nav-item"><a class="nav-link"
					href="javascript:void(0);"><i class="fas fa-tachometer-alt"></i>Documents</a>
				</li>
				<li class="nav-item"><a class="nav-link" href="login.jsp"><i
						class="fas fa-tachometer-alt"></i>Login/Register </a></li>
			</ul>
		</div>
	</nav>
