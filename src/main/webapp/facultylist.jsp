...
button {
	...
	color: #fff;
	padding: 8px;
	box-shadow: 0 0 30px 0 #009879, 0 0 30px 0 #009879, 0 0 10px 0 #009879
		inset;
}
/*  */
		...
		<tbody>
			<c:forEach var="table" items="${rs.rows}">
				<tr>
					...
					<td><c:out value="${table.info}" /></td>

				</tr>
			</c:forEach>
		</tbody>
	</table>
	<div class="d-flex justify-content-center"><a href="updatefaculty.jsp"><button type="button">Update</button></a>

	&nbsp&nbsp&nbsp<a href="deletefaculty.jsp"><button type="button">Delete</button></a></div>
